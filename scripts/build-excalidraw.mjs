...
const outfile = join(root, "public/js/vendor/excalidraw/excalidraw-editor.v5.js")
...
console.log(`\n✅ bundle 已生成：public/js/vendor/excalidraw/excalidraw-editor.v5.js`) // eslint-disable-line no-console

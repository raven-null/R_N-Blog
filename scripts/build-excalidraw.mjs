...
const outfile = join(root, "public/js/vendor/excalidraw/excalidraw-editor.v2.js")
...
console.log(`\n✅ bundle 已生成：public/js/vendor/excalidraw/excalidraw-editor.v2.js`) // eslint-disable-line no-console

...
- 项目结构调整：去除 `public/` 目录，所有文件直接放在项目根目录
- 文章页新增 E 键快捷键打开/关闭AI助手
- 完善从文章页返回首页的状态恢复功能（滚动位置、筛选标签、页码、搜索内容）
- 移除 `server/`、`package.json`、`.env` 等不存在的文件引用
- 更新博客版本为 1.3

### v2.0.0 (2026-07-21)

- 新增15套主题风格
- 新增主题动画效果（每套主题独特的Hero区域Canvas动画）
- 新增AI智能助手功能
- 新增图片灯箱功能（支持缩放、拖拽）
- 新增代码/引用块一键复制功能
- 新增文章目录搜索功能
